export default {
    ...
    theme: {
        extend: {
            ...
            backgroundImage: {
                grain: "radial-gradient(circle at 20% 20%, rgba(255,255,255,0.72), transparent 36%), radial-gradient(circle at 80% 0%, rgba(219,229,239,0.45), transparent 28%), radial-gradient(circle at 50% 100%, rgba(236,216,207,0.36), transparent 30%)"
            }
        }
    },
    plugins: []
